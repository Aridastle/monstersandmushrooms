...
public class ShroomsterStaffItem extends SwordItem implements GeoAnimatable {
    ...
    private PlayState predicate(AnimationState state) {
        state.getController().setAnimation(RawAnimation.begin().then("animation.shroomsterstaff.aura", Animation.LoopType.LOOP));
