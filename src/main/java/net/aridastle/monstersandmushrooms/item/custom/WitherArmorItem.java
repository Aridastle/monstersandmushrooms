...
public class WitherArmorItem extends ArmorItem implements GeoAnimatable, GeoItem {
    ...
    public WitherArmorItem(ArmorMaterial material, Type slot, Properties settings) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<WitherArmorItem>(this, "controller",
                20, this::predicate));
    }
