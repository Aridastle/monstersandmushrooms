...
public class MaggartArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<MaggartArmorItem>(this, "controller",
                20, this::predicate));
    }
