...
public class    GuardianArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public GuardianArmorItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
        super(material, slot, settings);
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<GuardianArmorItem>(this, "controller",
                20, this::predicate));
    }
