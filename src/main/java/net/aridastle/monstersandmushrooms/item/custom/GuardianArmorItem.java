...
public class    GuardianArmorItem extends ArmorItem implements GeoAnimatable, GeoItem {
    private AnimatableInstanceCache factory = new SingletonAnimatableInstanceCache(this);

    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.GUARDIAN, new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 200, 1)).build();

    public GuardianArmorItem(ArmorMaterial material, Type slot, Properties settings) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<GuardianArmorItem>(this, "controller",
                20, this::predicate));
    }
