...
public class EvokerArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<EvokerArmorItem>(this, "controller",
                20, this::predicate));
    }
