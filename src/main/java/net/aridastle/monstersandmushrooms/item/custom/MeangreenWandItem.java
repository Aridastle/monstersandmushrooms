...
public class MeangreenWandItem extends SwordItem implements GeoAnimatable {
    ...
    private PlayState predicate(AnimationState state) {
        state.getController().setAnimation(RawAnimation.begin().then("animation.meangreenwand.aura", Animation.LoopType.LOOP));
    ...
    private void explosionEffect(Player player, Level level) {
        ...
        level.explode(player,to.x, to.y, to.z, 2, Level.ExplosionInteraction.NONE);
    }
