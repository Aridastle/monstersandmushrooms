...
public class GnomeArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<GnomeArmorItem>(this, "controller",
                20, this::predicate));
    }
