...
public class BlazeWandItem extends SwordItem implements GeoAnimatable {
    ...
    private PlayState predicate(AnimationState state) {
        state.getController().setAnimation(RawAnimation.begin().then("animation.blazewand.aura", Animation.LoopType.LOOP));
