...
public class Gnome extends Monster implements IAnimatable {
    ...
    private PlayState attackPredicate(AnimationEvent event) {
        if(this.swinging && event.getController().getAnimationState().equals(AnimationState.Stopped)) {
            ...
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.gnome.attack", false));
            this.swinging = false;
        }
        return PlayState.CONTINUE;
    }
